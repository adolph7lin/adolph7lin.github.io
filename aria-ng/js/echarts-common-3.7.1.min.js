							...
							r && e.group.traverse(function(t) {
									t.isGroup || (t.progressive = r ? Math.floor(n++/i):-1,r&&t.stopAnimation(!0))});var o=t.get("blendMode")||null;e.group.traverse(function(t){t.isGroup||t.setStyle("blend",o)})}function _(t,e){var n=t.get("z"),i=t.get("zlevel");e.group.traverse(function(t){"group"!==t.type&&(null!=n&&(t.z=n),null!=i&&(t.zlevel=i))})}function b(t){var e=t._coordSysMgr;return N.extend(new T(t),{getCoordinateSystems:N.bind(e.getCoordinateSystems,e),getComponentByElement:function(e){for(;e;){var n=e.__ecComponentInfo;if(null!=n)return t._model.getComponent(n.mainType,n.index);e=e.parent}}})}function w(t){function e(t,e){for(var n=0;n<t.length;n++){var i=t[n];i[o]=e}}var n=0,i=1,r=2,o="__connectUpdateStatus";N.each(rt,function(a,s){t._messageCenter.on(s,function(a){if(dt[t.group]&&t[o]!==n){if(a&&a.escapeConnect)return;var s=t.makeActionFromEvent(a),l=[];N.each(ct,function(e){e!==t&&e.group===t.group&&l.push(e)}),e(l,n),G(l,function(t){t[o]!==i&&t.dispatchAction(s)}),e(l,r)}})})}/ * !
										...
										*
										...
										}), s.enableSubTypeDefaulter(h), s.enableTopologicalTravel(h, i), o.mixin(h, n(147)), t.exports = h
									}, function(t, e, n) {
										(function(e) {
											function i(t, e) {
										...
										var b = {
												...
												axisTick: function() {
													...
													if(t.get("axisTick.show") && !e.scale.isBlank())
														for(var n = t.getModel("axisTick"), i = this.opt, r = n.getModel("lineStyle"), o = n.get("length"), a = M(n, i.labelInterval), s = e.getTicksCoords(n.get("alignWithLabel")), u = e.scale.getTicks(), c = [], d = [], f = this._transform, p = 0; p < s.length; p++)
															if(!S(e, p, a)) {
																var g = s[p];
													...
													if(r && !n.scale.isBlank()) {
														...
														l.each(d, function(r, o) {
															if(!S(n, o, t.labelInterval)) {
																...
																var l = a.getTextColor() || e.get("axisLine.lineStyle.color"),
																	d = n.dataToCoord(r),
											...
											if(e || n || !i.ignore) {
												...
												if(this.__dirty || a.__dirty) {
													...
													if(!i.ignore) {
														i.attr("position", u);
														var f, p, g, m = 5 * r;
														if("end" === i.__position) f = [c[0] * m + u[0], c[1] * m + u[1]], p = c[0] > .8 ? "left" : c[0] < -.8 ? "right" : "center", g = c[1] > .8 ? "top" : c[1] < -.8 ? "bottom" : "middle";
										...
										m.beforeUpdate = s, m._createLine = function(t, e, n) {
											...
											var m, v, x, y, _ = s.getShallow("show"),
												b = l.getShallow("show"),
										...
										t.exports = _.extend({
											...
											render: function(t, e, n) {
												var o = t.coordinateSystem,
													...
													M = s(o, l),
													T = t.get("showSymbol"),
													I = T && !m && !t.get("showAllSymbol") && this._getSymbolIgnoreFunc(l, o),
													A = this._data;
											...
											_updateAnimation: function(t, e, n, i, r) {
												var o = this._polyline,
													...
													d = l.next,
													f = l.stackedOnNext;
												r && (u = c(l.current, n, r), h = c(l.stackedOnCurrent, n, r), d = c(l.next, n, r), f = c(l.stackedOnNext, n, r)), o.shape.__points = l.current, o.shape.points = u, v.updateProps(o, {
													shape: {
														points: d
													}
												}, s), a && (a.setShape({
												...
												_splitLine: function(t, e, n) {
													...
													if(!o.scale.isBlank()) {
														var a = t.getModel("splitLine"),
															...
															c = u(a, n);
														h = i.isArray(h) ? h : [h];
														for(var d = e.coordinateSystem.getRect(), f = o.isHorizontal(), p = 0, g = o.getTicksCoords(), m = o.scale.getTicks(), v = [], x = [], y = s.getLineStyle(), _ = 0; _ < g.length; _++)
															if(!l(o, _, c)) {
											...
											h = a.extend({
												...
												layoutInner: function(t, e, n) {
													...
													if(S[d] = v ? n[d] : g[d], S[f] = Math.max(g[f], m[f]), S[p] = Math.min(0, m[p] + _[1 - c]), s.__rectSize = n[d], v) {
														...
														M[d] = Math.max(n[d] - m[d] - b, 0), M[f] = S[f], s.setClipPath(new r.Rect({
															shape: M
														})), s.__rectSize = M[d]
										...
										if(!n(10).canvasSupported) {
											...
											c.prototype.brushVML = function(t) {
												...
												if(r) {
													...
													var W = G.style;
													if(_) {
														if(e && n) W.width = v(P * e * c / f) + "px", W.height = v(k * n * d / p) + "px";
														else {
															var q = new Image,
																j = this;
															q.onload = function() {
